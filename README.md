...
对于明确登记的 **4 只、1 个月周期**持仓，晚报可以在获准通道下生成一张手机优先的纵向
复合图：每只股票一张日线和一张仅含完整周线的周线，共 8 个面板。图中以低饱和粉、紫、
...
四只持仓的日线/完整周线复合图可以选择仅经 Server酱发送：图片先进入专用私有 Cloudflare
...
新版本的晚报链路会把六周期计划冻结为不可变的衍生研究档案；收盘同步在 15:30 或 18:30
