...
# volume and ``vw`` as turnover value.  A read-only 2026-08-27 calibration of
# 600000.SH's 2026-08-26 response returned v=950703 and vw=872154901 at prices
# 9.02--9.25.  Turnover divided by price and v is approximately 100, confirming
...
INFOWAY_EOD_UNIT_REFERENCE = (
    ...
    "plus 2026-08-27 read-only calibration: 600000.SH 2026-08-26 v=950703, "
    "vw=872154901, low=9.02, high=9.25; turnover/price implies v is 100-share lots "
